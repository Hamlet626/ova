...
import { UserDoc, UserRef } from '@/utils/firebase/database_consts';
...
import { Clear, Highlight, Search } from '@mui/icons-material';
          ...
          return [
            {
              ...
              getItems:async({ query }) =>  
                getAlgoliaResults<EDRec>({
                  ...
                  transformResponse:async({results,hits,facetHits})=>{
                    return [
                      await Promise.all(hits[0].map(async v=>{
